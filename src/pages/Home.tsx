    ...
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-sm">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-gray-800 dark:text-white">Somali Delights</h1>
          </div>
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 md:py-24">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 animate-fadeIn">Authentic Somali Cuisine</h1>
          <p className="text-xl md:text-2xl mb-8 max-w-2xl animate-fadeIn">Experience the rich flavors and cultural heritage of Somalia in every bite.</p>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                Founded in 2010, Somali Delights brings the authentic taste of Somali cuisine to Minneapolis. Our recipes have been passed down through generations, preserving the traditional flavors while adding our own modern twist.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                We take pride in using fresh, locally-sourced ingredients to create dishes that not only taste amazing but also represent the rich cultural heritage of Somalia.
              </p>
              <div className="flex items-center space-x-6">
                <div className="flex items-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Discover our most loved dishes, prepared with authentic Somali recipes and the freshest ingredients.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                id: 1,
                title: "Somali Rice (Bariis Iskukaris)",
                price: 12.99,
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white dark:bg-gray-800 text-center p-6 shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">contact@somalidelights.com</p>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold">Somali Delights</h3>
              </div>
              <p className="text-gray-400 mb-4">Authentic Somali cuisine in the heart of Minneapolis.</p>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Somali Delights. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
